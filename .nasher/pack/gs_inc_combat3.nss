...
//return TRUE nFeat can be used on oTarget
int gsC3VerifyFeat(int nFeat, object oTarget = OBJECT_SELF);
//return TRUE nSpell can/should be used on oTarget
...
int gsC3VerifySpell(int nSpell, object oTarget = OBJECT_SELF)
{
    ...
    if (gsC2GetResistSpell(nSpell, oTarget)) return FALSE;
