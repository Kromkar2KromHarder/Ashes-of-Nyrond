...
int gsLAGetCanSpeakLanguage(int nLanguage, object oPC = OBJECT_SELF)
{
    ...
    case GS_LA_LANGUAGE_DRACONIC:
        return nSubRace == GS_SU_SPECIAL_KOBOLD ||
               gsCMGetHasClass(CLASS_TYPE_DRAGONDISCIPLE, oPC) ||
...
string gsLATranslateThief(string sString)
{
    ...
    if (sCL == "a") return GS_T_16777370;
    if (sCL == "b") return GS_T_16777371;
    if (sCL == "c") return GS_T_16777372;
    if (sCL == "d") return GS_T_16777373;
    if (sCL == "e") return GS_T_16777374;
    if (sCL == "f") return GS_T_16777375;
    if (sCL == "g") return GS_T_16777376;
    if (sCL == "h") return GS_T_16777377;
    if (sCL == "i") return GS_T_16777378;
    if (sCL == "j") return GS_T_16777379;
    if (sCL == "k") return GS_T_16777380;
    if (sCL == "l") return GS_T_16777381;
    if (sCL == "m") return GS_T_16777382;
    if (sCL == "n") return GS_T_16777383;
    if (sCL == "o") return GS_T_16777384;
    if (sCL == "p") return GS_T_16777385;
    if (sCL == "q") return GS_T_16777386;
    if (sCL == "r") return GS_T_16777387;
    if (sCL == "s") return GS_T_16777388;
    if (sCL == "t") return GS_T_16777389;
    if (sCL == "u") return GS_T_16777390;
    if (sCL == "v") return GS_T_16777391;
    if (sCL == "w") return GS_T_16777392;
    if (sCL == "x") return GS_T_16777393;
    if (sCL == "y") return GS_T_16777394;
    if (sCL == "z") return GS_T_16777395;

    return GS_T_16777383;
}
